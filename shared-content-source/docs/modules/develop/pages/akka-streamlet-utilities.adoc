...
[source,scala]
----
include::example$sensor-data-scala/src/main/scala/sensordata/SensorDataHttpIngress.scala[]
----
...
[source,java]
----
include::example$sensor-data-java/src/main/java/sensordata/SensorDataIngress.java[]
----
...
[source,scala]
----
include::example$sensor-data-scala/src/main/scala/sensordata/SensorDataStreamingIngress.scala[]
----
...
[source,java]
----
include::example$sensor-data-java/src/main/java/sensordata/SensorDataStreamingIngress.java[]
----
...
[source,scala]
----
include::example$sensor-data-scala/src/main/scala/sensordata/MetricsValidation.scala[]
----
...
[source,java]
----
include::example$sensor-data-java/src/main/java/sensordata/MetricsValidation.java[]
----
