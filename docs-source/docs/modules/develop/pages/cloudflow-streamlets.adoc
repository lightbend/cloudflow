...
Please read xref:ROOT:index.adoc[Basic concepts] for an introduction. This section goes into more depth on streamlets and how to develop them. Akka and Flink streamlets can be developed in Scala or Java, Spark streamlets can only be developed in Scala.
...
[source,json]
----
include::ROOT:example$call-record-aggregator/datamodel/src/main/avro/CallRecord.avsc[]
----
...
[source,scala]
----
include::ROOT:example$call-record-aggregator/akka-cdr-ingestor/src/main/scala/carly/ingestor/CallRecordIngress.scala[]
----
...
[source,scala]
----
include::ROOT:example$call-record-aggregator/spark-aggregation/src/main/scala/carly/aggregator/CallStatsAggregator.scala[tags=docs-schemaAware-example]
----
...
[source,java]
----
include::ROOT:example$sensor-data-java/src/main/java/sensordata/FilterStreamlet.java[]
----
...
[source,scala]
----
include::ROOT:example$sensor-data-scala/src/main/scala/sensordata/SensorDataFileIngress.scala[]
----
