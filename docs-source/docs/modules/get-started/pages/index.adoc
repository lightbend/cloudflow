...
ifdef::review[REVIEWERS: I added the intro paragraph and changed the order to first develop the app, then install CLI, run in sandbox, then setup cluster and run in cluster.]
