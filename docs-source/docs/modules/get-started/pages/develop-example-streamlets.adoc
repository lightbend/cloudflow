...
[source,scala]
----
include::shared-content:develop:example$sensor-data-scala/src/main/scala/sensordata/SensorDataHttpIngress.scala[]
----
...
[source,scala]
----
include::shared-content:develop:example$sensor-data-scala/src/main/scala/sensordata/SensorDataToMetrics.scala[]
----
...
[source,scala]
----
include::shared-content:develop:example$sensor-data-scala/src/main/scala/sensordata/MetricsValidation.scala[]
----
...
[source,scala]
----
include::shared-content:develop:example$sensor-data-scala/src/main/scala/sensordata/SensorDataUtils.scala[]
----
...
[source,scala]
----
include::shared-content:develop:example$sensor-data-scala/src/main/scala/sensordata/ValidMetricLogger.scala[]
----
...
[source,scala]
----
include::shared-content:develop:example$sensor-data-scala/src/main/scala/sensordata/InvalidMetricLogger.scala[]
----
...
[source,scala]
----
include::shared-content:develop:example$sensor-data-scala/src/main/scala/sensordata/JsonFormats.scala[]
----
...
[source,scala]
----
include::shared-content:develop:example$sensor-data-scala/src/main/scala/package.scala[]
----
