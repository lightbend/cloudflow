...
case class ProtobufInlet[T <: GeneratedMessage: GeneratedMessageCompanion](name: String, hasUniqueGroupId: Boolean = false)
  ...
  def withUniqueGroupId: ProtobufInlet[T] = copy(hasUniqueGroupId = true)
}
