...
**Download and run the [bootstrap script](https://github.com/lightbend/cloudflow/releases/download/v2.0.8/bootstrap-install-script-2.0.8.sh) to deploy the installer and instantiate a `cloudflow` custom resource.**:
