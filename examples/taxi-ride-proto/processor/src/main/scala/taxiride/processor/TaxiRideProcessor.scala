...
class TaxiRideProcessor extends FlinkStreamlet {
  ...
  @transient val inTaxiRide = ProtoInlet[TaxiRide]("in-taxiride")
  @transient val inTaxiFare = ProtoInlet[TaxiFare]("in-taxifare")
  @transient val out        = ProtoOutlet[TaxiRideFare]("out", _.rideId.toString)
