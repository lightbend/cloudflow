package taxiride.akka.processor.actors.optimized.persistent
...
// State
final case class TaxiState(rideState: Map[Long, TaxiRide], fareState: Map[Long, TaxiFare]) extends JacksonCborSerializable{
