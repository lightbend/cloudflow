...
object RawCarDataGenerator extends AkkaStreamlet {
  ...
  override def createLogic = new RunnableGraphStreamletLogic() {
    ...
    override def runnableGraph() =  Source.repeat(NotUsed)
  ...
  def generateCarERecord(): ConnectedCarERecord = {
    ...
    ConnectedCarERecord(System.currentTimeMillis,driver.carId, driver.driver,
      randomBattery, randomTemp, randomPowerConsumption, randomSpeed,
      randomStatus)
  }
