...
ifdef::adp[This page describes the required environment to prepare for development. Please see xref:install:installing-cloudflow.adoc[Installing Cloudflow] for instructions on how to install Cloudflow on a Kubernetes cluster.]
