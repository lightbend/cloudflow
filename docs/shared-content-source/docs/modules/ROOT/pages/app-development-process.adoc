...
Cloudflow applications are packaged as a Docker images that contain the necessary dependencies to run the different streamlets on their respective backends.
...
The process of building the application created and published those Docker images. 
...
[info] Step 1/4 : FROM lightbend/akka-base:2.0.0-cloudflow-akka-2.6.5-scala-2.12
[info]  ---> bbcdde34a60a
