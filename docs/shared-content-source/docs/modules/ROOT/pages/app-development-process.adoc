...
For more details on externalized Flink and Spark integrations, please have a look at xref:develop:cloudflow-contrib-change-me.adoc[Cloudflow Contrib] documentation.
