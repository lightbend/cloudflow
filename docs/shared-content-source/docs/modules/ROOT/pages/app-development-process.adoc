...
[source, scala]
----
include::{code-snippets-version}@docsnippets:ROOT:example$spark-scala/src/main/scala/cloudflow/sparkdoc/MovingAverageSparklet.scala[tag=spark-streamlet-example]
----
...
[source, json]
----
include::{code-snippets-version}@docsnippets:ROOT:example$spark-scala/src/main/blueprint/blueprint.conf[]
----
