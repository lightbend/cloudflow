...
[source, scala]
----
include::docsnippets:ROOT:example$spark-scala/src/main/scala/cloudflow/sparkdoc/MovingAverageSparklet.scala[tag=spark-streamlet-example]
----
...
[source, json]
----
include::docsnippets:ROOT:example$spark-scala/src/main/blueprint/blueprint.conf[]
----
