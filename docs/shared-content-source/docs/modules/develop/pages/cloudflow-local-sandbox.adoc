...
In the example below, we see the summary output of `call-record-aggregator`, one of the Cloudflow examples available at https://github.com/lightbend/cloudflow/blob/main/examples/call-record-aggregator/[examples/call-record-aggregator]:
