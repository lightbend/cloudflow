...
For more information on setting up named Kafka clusters see the xref:administration:installing-cloudflow.adoc[Default and named Kafka clusters] section of the Installing Cloudflow docs.
