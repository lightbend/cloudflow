...
```
 include::docsnippets:ROOT:example$spark-scala/src/main/scala/com/example/Feature.scala[]
```
...
```
 include::docsnippets:ROOT:example$spark-scala/src/main/scala/com/example/Feature.scala[tag=something_interesting]
```
