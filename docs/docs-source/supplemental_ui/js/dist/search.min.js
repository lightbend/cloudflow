...
window.antoraLunr=function(e){const t=document.getElementById("search-script").dataset,n=t.basePath;t.pagePath;var r=document.getElementById("search-input"),a=document.createElement("div");function s(e,t){var n=[],r=t[0],a=t[1],s=e.text,d=document.createElement("span");d.classList.add("search-result-highlight"),d.innerText=s.substr(r,a);var i=r+a,u=s.length-1,c=i+15>u?u:i+15,o=r-15<0?0:r-15;return 0===r&&i===u?n.push(d):0===r?(n.push(d),n.push(document.createTextNode(s.substr(i,c)))):i===u?(n.push(document.createTextNode(s.substr(0,r))),n.push(d)):(n.push(document.createTextNode("..."+s.substr(o,r-o))),n.push(d),n.push(document.createTextNode(s.substr(i,c-i)+"..."))),n}function d(e,t,n){var r,a=[],s=n[0],d=n[1],i=document.createElement("span");i.classList.add("search-result-highlight"),r=e?t.titles.filter((function(t){return t.id===e}))[0].text:t.title,i.innerText=r.substr(s,d);var u=s+d,c=r.length-1;return 0===s&&u===c?a.push(i):0===s?(a.push(i),a.push(document.createTextNode(r.substr(d,c)))):u===c?(a.push(document.createTextNode(r.substr(0,s))),a.push(i)):(a.push(document.createTextNode(r.substr(0,s))),a.push(i),a.push(document.createTextNode(r.substr(u,c)))),a}function i(e,t,r){e.forEach((function(e){var a,i=e.ref;i.includes("#")&&(a=i.substring(i.indexOf("#")+1),i=i.replace("#"+a,""));var u=t[i],c=function(e,t,n){var r=[];for(var a in e){var i=e[a];for(var u in i){var c=i[u];if(c.position){var o=c.position[0];"title"===u?r=d(t,n,o):"text"===u&&(r=s(n,o))}}}return r}(e.matchData.metadata,a,u);r.appendChild(function(e,t,r){var a=document.createElement("div");a.classList.add("search-result-document-title"),a.innerText=e.title;var s=document.createElement("div");s.classList.add("search-result-document-hit");var d=document.createElement("a"),i=n;d.href=i+t.ref,s.appendChild(d),r.forEach((function(e){d.appendChild(e)}));var u=document.createElement("div");return u.classList.add("search-result-item"),u.appendChild(a),u.appendChild(s),u.addEventListener("mousedown",(function(e){e.preventDefault()})),u}(u,e,c))}))}function u(e,t,n){for(;a.firstChild;)a.removeChild(a.firstChild);if(""!==n.trim()){var r=function(e,t){var n=e.search(t);return n.length>0||(n=e.search(t+"*")).length>0?n:n=e.search("*"+t+"*")}(e,n),s=document.createElement("div");s.classList.add("search-result-dataset"),a.appendChild(s),r.length>0?i(r,t,s):s.appendChild(function(e){var t=document.createElement("div");t.classList.add("search-result-item");var n=document.createElement("div");n.classList.add("search-result-document-hit");var r=document.createElement("strong");return r.innerText='No results found for query "'+e+'"',n.appendChild(r),t.appendChild(n),t}(n)),a.classList.add("active")}}return a.classList.add("search-result-dropdown-menu"),r.parentNode.appendChild(a),{init:function(t){var n,s,d,i,c=Object.assign({index:e.Index.load(t.index),store:t.store}),o=(n=function(){u(c.index,c.store,r.value)},s=100,function(){var e=this,t=arguments,r=function(){i=null,d||n.apply(e,t)},a=d&&!i;clearTimeout(i),i=setTimeout(r,s),a&&n.apply(e,t)});r.addEventListener("keydown",o),r.addEventListener("blur",(function(e){for(;a.firstChild;)a.removeChild(a.firstChild),a.classList.remove("active")}))}}}(window.lunr);