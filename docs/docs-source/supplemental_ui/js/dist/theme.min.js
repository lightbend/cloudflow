...
groupChangeListeners=[],window.groupChanged=function(t){groupChangeListeners.push(t)},$((function(){var t="antoraGroups",e=function(t){for(var e=t+"=",n=decodeURIComponent(document.cookie).split(";"),r=0;r<n.length;r++){for(var a=n[r];" "==a.charAt(0);)a=a.substring(1);if(0==a.indexOf(e))return a.substring(e.length,a.length)}return""}(t),n={},r={},a={};function s(e,a){n[e]=a,function(t,e,n){n||(n=365);var r=new Date;r.setTime(r.getTime()+24*n*60*60*1e3);var a="expires="+r.toGMTString();document.cookie=t+"="+e+";"+a+";path=/"}(t,JSON.stringify(n)),$("select").has("option[value="+a+"]").val(a);for(var s=0;s<r[e].length;s++){var d=r[e][s];d==a?$("."+a).show():$("."+d).hide()}$("dl.tabbed").each((function(){$(this).find("dt").each((function(){var t=$(this);o(t)==a&&i(t)}))}));for(s=0;s<groupChangeListeners.length;s++)groupChangeListeners[s](a,e,r)}function i(t){var e=t.parent("dl");e.find(".current").removeClass("current").next("dd").removeClass("current").hide(),t.addClass("current");var n=t.next("dd").addClass("current").show();e.css("height",t.height()+n.height())}function o(t){var e=t.next("dd").find("pre").attr("class");if(e)for(var n=e.split(" "),r=new RegExp("^group-.*"),a=0;a<n.length;a++)if(r.test(n[a]))return n[a];return"group-"+t.find("a").text().toLowerCase()}""!=e&&(n=JSON.parse(e)),$(".tabset dl").each((function(){var t=$(this);t.addClass("tabbed");var e=t.find("dt");e.each((function(t){var e=$(this);e.html('<a href="#tab'+t+'">'+e.text()+"</a>")})),t.find("dd").each((function(t){var e=$(this);e.hide(),e.find("blockquote").length&&e.addClass("has-note")})),i(e.first()),e.first().addClass("first"),e.last().addClass("last")})),$(".supergroup").each((function(){var t=$(this).attr("name").toLowerCase(),e=$(this).find(".group"),i=n[t];i||(i="group-"+e.first().text().toLowerCase(),n[t]=i),r[t]=[],e.each((function(){var e="group-"+$(this).text().toLowerCase();r[t].push(e),a[e]=t})),s(t,i),$(this).on("change",(function(){s(t,this.value)}))})),$("dl.tabbed dt a").click((function(t){t.preventDefault();var e=$(this).parent("dt"),n=(e.parent("dl"),o(e)),r=a[n];r?s(r,n):i(e)}))}));
/*!
Theme JS version 1.0
*/
var ytID;function OptanonWrapper(){$("a.yt-widget").each((function(e){var t=$(this),n=$(this).attr("href"),a=t[0].search;let i=new URLSearchParams(a);ytID=i.get("v"),$(this).before('<div class="flex-video-wrapper"><div class="flex-video"><div id="yt-'+ytID+'" class="cookie-warning youtube-warning"><a class="optanon-allow-all">Accept cookies to view video</a><span>Alternatively you can watch the video <a href="'+n+'" target="_blank">here on YouTube</a></span></div></div></div>'),$(this).removeAttr("href").removeClass("yt-widget").addClass("yt-widget-hide")})),$(".youtube-warning").each((function(e){Optanon.InsertHtml('<iframe id="player" class="youtube-embed-player" src="//www.youtube.com/embed/'+ytID+'?rel=0&modestbranding=0" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>',"yt-"+ytID,null,{deleteSelectorContent:!0},4)}))}var munchkinLive=!1;!function(){var e=!1;function t(){!1===e&&(e=!0,Munchkin.init("558-NCX-702",{asyncOnly:!0,disableClickDelay:!0}),munchkinLive=!0)}var n=document.createElement("script");n.type="text/javascript",n.src="//munchkin.marketo.net/munchkin.js",n.onreadystatechange=function(){"complete"!=this.readyState&&"loaded"!=this.readyState||t()},n.onload=t,document.getElementsByTagName("head")[0].appendChild(n)}(),function(e){e((function(){var t="#page-content";e("#page-viewed-trigger").length&&(t="#page-viewed-trigger");new Waypoint.Inview({element:e(t)[0],entered:function(t){e.event.trigger({type:"pageContentViewed"})}});var n=!1;e(document).on("pageContentViewed",(function(e){console.log(window.location.pathname);var t="/viewed"+window.location.pathname;!n&&munchkinLive&&(Munchkin.munchkinFunction("visitWebPage",{url:t}),n=!0)}))}))}(jQuery);