...
This chapter describes how to build a simple "Wind Turbine" Cloudflow application, how to run it localling in the sandbox, and how to deploy and run it on a Google Kubernetes Engine (GKE) cluster. 
...
. xref:setup-k8s-cluster.adoc[Set up a Kubernetes cluster]
