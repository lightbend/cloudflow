...
Detailed instructions on how to install Cloudflow on a Kubernetes cluster are described in the https://github.com/lightbend/cloudflow/tree/master/installer[Cloudflow installer section] of the GitHub repo.
