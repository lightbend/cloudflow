...
Cloudflow provides sbt plugins for the supported runtimes, Akka Streams, Spark and Flink. 
...
[source,scala]
----
include::{cloudflow-examples-version}@docsnippets:ROOT:example$sensor-data-scala/build.sbt[tag=docs-projectSetup-example]
----
+
