...
- add libraryDependency defined in Cloudflow sbt-plugin variable `Cloudflow.library.CloudflowAvro`
...
- add libraryDependency defined in Cloudflow sbt-plugin variable `Cloudflow.library.CloudflowProto`
