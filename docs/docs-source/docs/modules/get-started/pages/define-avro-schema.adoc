...
[source,json]
----
include::{cloudflow-examples-version}@docsnippets:ROOT:example$sensor-data-scala/src/main/avro/SensorData.sensor-data-scala/src/main/avro/Measurements.avcs[]
----
...
[source,json]
----
include::{cloudflow-examples-version}@docsnippets:ROOT:example$sensor-data-scala/src/main/avro/Measurements.avcs[]
----
...
[source,json]
----
include::{cloudflow-examples-version}@docsnippets:ROOT:example$sensor-data-scala/src/main/avro/Metric.sensor-data-scala/src/main/avro/Measurements.avcs[]
----
...
[source,json]
----
include::{cloudflow-examples-version}@docsnippets:ROOT:example$sensor-data-scala/src/main/avro/InvalidMetric.avcs[]
----
