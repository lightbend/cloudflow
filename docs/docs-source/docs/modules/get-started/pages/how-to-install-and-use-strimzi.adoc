...
Install the latest version of Strimzi.
  ...
  helm install strimzi strimzi/strimzi-kafka-operator --namespace clodflow

After the install complete, the Strimzi Kafka operator should be running the in the `cloudflow` namespace.
