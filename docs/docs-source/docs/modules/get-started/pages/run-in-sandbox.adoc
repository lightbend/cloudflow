...
Now that we have the application code implemented, let's try to build the application and exercise its functionality locally without requiring deploying it in a cluster.
