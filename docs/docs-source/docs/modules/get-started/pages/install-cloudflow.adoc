...
This document details how to install Cloudflow and dependencies on Cloudflow like the Spark and Flink operator, using the `Helm` and `kubectl` command-line tools. 
...
// - TODO more information about Kafka has to be added
