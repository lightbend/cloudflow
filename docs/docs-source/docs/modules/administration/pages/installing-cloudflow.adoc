...
. xref:how-to-install-and-use-strimzi.adoc[How to install Strimzi and create a Kafka cluster]
...
. xref:installing-spark-operator.adoc[Installing the Spark Operator]
...
. xref:installing-flink-operator.adoc[Installing the Flink Operator]
